...
class ManageUser extends React.Component {
    constructor(props) {
        ...
        this.state = {
            users: [],
            originUsers: [],
            header: ["Tên tài khoản", "Ngày tạo", "Trạng thái", "Tổng bài viết", "Thao tác"],
            categories: [],
            status: [],
            maxItems: 10,
            currentPage: 1,
                        ...
                        <div className="footer">
                            <PagingControl
                                ...
                                maxPage={
                                    ...
                                    Math.floor(userArrParse.length / maxItems) === userArrParse.length / maxItems ? Math.floor(userArrParse.length / maxItems) : Math.floor(userArrParse.length / maxItems) + 1
                                }
                                currentPage={currentPage} />
                        </div>
                    </div>
