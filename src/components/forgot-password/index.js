                ...
                <Form className="form__auth" onSubmit={this.onSubmit}>
                    ...
                    <div className='form__content'>
                        ...
                        <Form.Group controlId="formGroupPassword">
                            ...
                            <Form.Control type="password" placeholder="Mật khẩu" name='password' onChange={this.handleChange}/>
                        </Form.Group>
                        <Form.Group controlId="formGroupNew">
                            <Form.Label>Mật khẩu mới</Form.Label>
                            <Form.Control type="text" placeholder="Email" name='newpassword'onChange={this.handleChange}/>
                        </Form.Group>
                    </div>
                    <Button className='button__normal' type='submit'>Hoàn thành</Button>
