                ...
                <Form className="form__auth" onSubmit={this.onSubmit}>
                    ...
                    <div className='form__content'>
                        <Form.Group controlId="formGroupUsername">
                            ...
                            <Form.Control type="text" placeholder="Tên đăng nhập" name='username' onChange={this.handleChange} className={isEmpty(get(formatErrs,['username'])) ?'':'border__red'}/>
                            <div className='alert__error'>{isEmpty(get(formatErrs,['username'])) ? '' : get(formatErrs,['username'])}</div>
                        </Form.Group>
                        <Form.Group controlId="formGroupPassword">
                            <Form.Label className={isEmpty(get(formatErrs,['password'])) ?'':'text__red'}>Mật khẩu</Form.Label>
                            <Form.Control type="password" placeholder="Mật khẩu" name='password' onChange={this.handleChange} className={isEmpty(get(formatErrs,['password'])) ?'':'border__red'}/>
                            <div className='alert__error'>{get(formatErrs,['password'])}</div>
                        </Form.Group>
                        <Form.Group controlId="formGroupEmail">
                            <Form.Label className={isEmpty(get(formatErrs,['email'])) ?'':'text__red'}>Email</Form.Label>
                            <Form.Control type="text" placeholder="Email" name='email'onChange={this.handleChange} className={isEmpty(get(formatErrs,['email'])) ?'':'border__red'}/>
                            <div className='alert__error'>{get(formatErrs,['email'])}</div>
                        </Form.Group>
                        <Form.Group controlId="formGroupFullName">
                            <Form.Label className={isEmpty(get(formatErrs,['fullname'])) ?'':'text__red'}>Họ và tên</Form.Label> 
                            <Form.Control type="text" placeholder="Họ và tên" name='fullname'onChange={this.handleChange} className={isEmpty(get(formatErrs,['fullname'])) ?'':'border__red'}/>
                            <div className='alert__error'>{get(formatErrs,['fullname'])}</div>
                        </Form.Group>
                        <Form.Group controlId="formGroupGender">
                            <Form.Label className={isEmpty(get(formatErrs,['gender'])) ?'':'text__red'}>Giới tính</Form.Label>
                            <Form.Control as='select' onChange={this.handleChange} name='gender' value={gender} className={isEmpty(get(formatErrs,['gender'])) ?'':'border__red'}>
                                <option disabled value={-1}>Chọn</option>
